package baitapjava.example.btthjava.utils;
import baitapjava.example.btthjava.service.CustomUserDetailService;
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/css/**", "/js/**", "/", "/oauth/**", "/register", "/error", "/books/edit/**", "/cart", "/cart/**")
